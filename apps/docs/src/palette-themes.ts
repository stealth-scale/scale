/**
 * Lists the nine themes drawn from four colors stated outright, in the order the switcher offers
 * them after Ink.
 *
 * @remarks
 *   Kept apart from `theme.config.ts` because the house caps a file's dependencies at ten, and the
 *   statement needs Ink and its own type beside these nine.
 */
